...
// Restoring a message
router.post('/restore1', (request, response) => {
  request.session.data['message1-removed'] = false;
  response.redirect('/pages/messages/your-messages');
});

router.post('/restore2', (request, response) => {
  request.session.data['message2-removed'] = false;
  response.redirect('/pages/messages/your-messages');
});

router.post('/restore3', (request, response) => {
  request.session.data['message3-removed'] = false;
  response.redirect('/pages/messages/your-messages');
});

router.post('/restore4', (request, response) => {
  request.session.data['message4-removed'] = false;
  response.redirect('/pages/messages/your-messages');
});

// Message-1 gets
router.get('/pages/messages/message-1', (request, response, next) => {
...
// Message-2 gets
router.get('/pages/messages/message-2', (request, response, next) => {
...
// Message-3 gets
router.get('/pages/messages/message-3', (request, response, next) => {
...
// Message-4 gets
router.get('/pages/messages/message-4', (request, response, next) => {
...
// Your-messages gets
router.get('/pages/messages/your-messages', (request, response, next) => {
  response.locals.is1Removed = request.session.data['message1-removed'];
  response.locals.is2Removed = request.session.data['message2-removed'];
  response.locals.is3Removed = request.session.data['message3-removed'];
  response.locals.is4Removed = request.session.data['message4-removed'];
...
router.get('/pages/messages/removed-messages', (req, res) => {
...
router.post('/pages/services/gp-appointment-type-answer', (req, res) => {
  const install = req.session.data['gp-appointment-type'];
...
router.post('/pages/services/gp-appointment-invite-answer', (req, res) => {
  const install = req.session.data['gp-appointment-invite'];
